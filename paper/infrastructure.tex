...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=.5\linewidth]{figs/samplesize}
\end{center}
\caption{Increased accuracy with increasingly large sample rates (20s, left; 10s, right). Even at times of low ambient signal noise, weighted centroid measurements can be inconsistent (light grey), a problem remedied by averaging the 5 most closely clustered centroids (dark grey). The star represents the actual device location.}
\end{figure}