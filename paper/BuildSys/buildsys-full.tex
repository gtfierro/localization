...
\title{Full Paper for ACM Buildsys Proceedings}
...
\begin{abstract}
This paper provides a sample of a \LaTeX\ document for ACM Buildsys Workshop. 
...
Both files are also hacked by John Heidemann (2006) and Rasit Eskicioglu (2011).
