...
class Floor(object):
  ...
  def __init__(self, floor_image, collector,*macs):
    ...
    self.json = Formatter("data.json", 600, 240, [ ( (0,0), (0, 240), (91,240), (91,0),      ),
                                         ( (91,0),(91, 240) , (205, 240), (205, 0),     ),
                                         ( (205,0),(205, 240), (415, 240), (415, 0),    ),
                                         ( (415,0),(415, 240), (515, 240), (515, 0),    ),
                                         ( (515,0),(515, 240), (640, 240), (640, 0),    )])
    print "here"
    self.json_tmp = []
